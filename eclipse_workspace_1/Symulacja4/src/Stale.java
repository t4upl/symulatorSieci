...
public class Stale {
	...
	static  final boolean isVirtualnyProsument = true;
	...
	//nie final, bo jakbys chcial robic testy to na 2 prosumentach (a nie na 16)
	...
	static final double pojemnoscAkumualtoraEV=85;
	static final double predkoscAkumulatoraEV=18.89f;
	static final double kosztAmortyzacjiAkumulatoraEV=0.078f;
	
	//energia potrzebna na przeproawdzenie podrozy
	static final double podrozMinimumEnergii = 3.6f;
	static final double podrozPredkoscAkumulatoraEV = predkoscAkumulatoraEV/2;
